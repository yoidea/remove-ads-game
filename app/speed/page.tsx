...
export default function Create() {
	...
	const [fullScreenAdButtonText, setFullScreenAdButtonText] =
		useState("2秒後にスキップ")
	const [fullScreenAdButtonEnabled, setFullScreenAdButtonEnabled] =
		useState(false)
	...
	const InitialAd = (
		...
		>
			...
			<div style={{ width: "100%", height: "100%" }}>
				<button className="btn btn-lg mb-3 start-btn" onClick={handleGameStart}>
					チャレンジ開始
				</button>
			</div>
		</Modal>
		...
		<>
			<div className="flex items-center h-[100dvh]">
				<div className="container">
					...
					{FullScreenAd}
					<div
						className={`${gameClear ? "score-board score-board-wrap" : "score-board"}`}
					>
						<div className="item">
							<div className="timer-container">
								<svg width="160" height="160">
									<circle
										...
										stroke-dashoffset={`${-376 * (seconds / timerSeconds)}`}
										stroke-width="8"
										stroke="#26a79a"
										fill="none"
									/>
